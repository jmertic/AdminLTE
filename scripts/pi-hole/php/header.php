...
<head>
    ...
    <meta http-equiv="Content-Security-Policy" content="default-src 'none'; base-uri 'none'; child-src 'self'; form-action 'self'; frame-src 'self'; font-src 'self' data:; connect-src 'self'; img-src 'self'; manifest-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li<?php if($scriptname === "speedtest.php"){ ?> class="active"<?php } ?>>
                    <a href="speedtest.php">
                        <i class="fa fa-fw menu-icon fa-tachometer-alt"></i> <span>Speedtest</span>
                    </a>
                </li>
